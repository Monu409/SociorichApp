...
import static com.sociorich.app.app_utils.AppApis.CANCEL_REQUEST;
import static com.sociorich.app.app_utils.AppApis.SEND_REQUEST;
...
public class FriendsAdapter extends RecyclerView.Adapter<FriendsAdapter.FrndHolder> {
    ...
    public void onBindViewHolder(@NonNull FrndHolder frndHolder, int i) {
        ...
        if(!imgPath.equals("")) {
            Glide.with(context).load(imgPath).into(frndHolder.frndImg);
        }
    ...
    class FrndHolder extends RecyclerView.ViewHolder {
        ...
        public CircleImageView frndImg;
