...
import com.sociorich.app.activities.ChangeNumberActivity;
...
import static com.sociorich.app.app_utils.AppApis.UPDATE_PHONENO;
...
//            phoneEdt.setText(phoneStr);
        ...
        phoneSvBtn.setOnClickListener(v->{
            ...
            if(!ConstantMethods.isValidMobile(phoneStr)){
