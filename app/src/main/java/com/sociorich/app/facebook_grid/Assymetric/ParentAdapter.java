...
import com.sociorich.app.facebook_grid.Assymetric.model.ItemList;
...
public class ParentAdapter extends RecyclerView.Adapter<ParentAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            recyclerView.addItemDecoration(new SpacesItemDecoration(mCon.getResources().getDimensionPixelSize(R.dimen.recycler_padding)));
