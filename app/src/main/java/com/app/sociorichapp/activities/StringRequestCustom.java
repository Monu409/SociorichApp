...
public class StringRequestCustom extends com.android.volley.toolbox.StringRequest {
   // M_Shared_Pref m_shared_pref;
    Context context;
    public StringRequestCustom(Context ctx, int method, String url, Response.Listener listener, Response.ErrorListener errorListener) {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        params.put("authorization", "Basic c3JjaC13ZWItYXBwOlhZN2ttem9OemwxMDA=");
