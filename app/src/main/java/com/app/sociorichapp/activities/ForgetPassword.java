...
EditText email;
    ...
    String mainurl = BASE_URL+"api/v1/user/forgotpwd",emaiid;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ConstantMethods.setTitleAndBack(this,"Forgot Password");
    }
    ...
    public void submit(View arg){
        ...
        {
            Toast.makeText(getApplicationContext(), "Enter email id/mobile number", Toast.LENGTH_LONG).show();
        }
        else {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(key.equals("error")){
                    ...
                    Intent intent = new Intent(ForgetPassword.this, OTP_Screen.class);
