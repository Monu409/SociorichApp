...
import com.app.sociorichapp.adapters.MyAdapter;
import com.app.sociorichapp.app_utils.AndroidMultiPartEntity;
import com.app.sociorichapp.app_utils.ConstantMethods;
import com.app.sociorichapp.app_utils.DbHelper;
import com.app.sociorichapp.app_utils.FileUtils;
import com.app.sociorichapp.app_utils.Utility;
...
import static com.app.sociorichapp.app_utils.AppApis.UPLAOD_SINGLE_IMAGE;
import static com.app.sociorichapp.app_utils.Utility.MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE;


public class Create_Post extends BaseActivity implements AdapterView.OnItemSelectedListener {
    private int SELECT_FILE = 1;
    static private boolean isUpdate;
    private String mCurrentPhotoPath;
    static String postupdation = "N";
    String strurl = BASE_URL + "api/v1/media/upload";
    private static final String TAG = Create_Post.class.getSimpleName();
    ...
    public void choosefile(View arg) {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(Create_Post.this);
...
//                        mImageView.setImageBitmap(mImageBitmap);
    ...
    private boolean askForPermission() {
        ...
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
            int hasCallPermission = ContextCompat.checkSelfPermission(Create_Post.this,
                    Manifest.permission.READ_EXTERNAL_STORAGE);
            if (hasCallPermission != PackageManager.PERMISSION_GRANTED) {
                // Ask for permission
                // need to request permission
                if (ActivityCompat.shouldShowRequestPermissionRationale(Create_Post.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    // explain
                    showMessageOKCancel(
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(Create_Post.this,
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface arg0) {
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                        ContextCompat.getColor(Create_Post.this, android.R.color.holo_blue_light));
                dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(
                        ContextCompat.getColor(Create_Post.this, android.R.color.holo_red_light));
            }
        });
    ...
    public class Registration_Data extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(Create_Post.this);
